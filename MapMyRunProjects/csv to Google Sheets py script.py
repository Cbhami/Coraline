...
df = pd.read_csv(r"/Users/cole/Library/CloudStorage/OneDrive-Personal/Coraline/Resources/csv data/user94403143_workout_history.csv")
...
df.to_csv(r'/Users/cole/Library/CloudStorage/OneDrive-Personal/Coraline/Resources/csv data/user94403143_workout_history.csv', index=False)   
...
#Mac
credentials = ServiceAccountCredentials.from_json_keyfile_name(r'/Users/cole/Library/CloudStorage/OneDrive-Personal/Important Keys/client_secret.json', scope)
client = gspread.authorize(credentials)

spreadsheet = client.open('Data_File')

#Mac
with open(r'/Users/cole/Library/CloudStorage/OneDrive-Personal/Coraline/Resources/csv data/user94403143_workout_history.csv', 'r') as file_obj:
    content = file_obj.read()
    client.import_csv(spreadsheet.id, data=content)
#Win
